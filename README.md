...
Please also note that this is not a comprhensive list of everything necessary to make a successful chess game, but hopefully is enough to demonstrate the thinking I go through when beginning a project.
...
=================
   ...
   * [Main commands to be used:](#main-commands-to-be-used)
         ...
         * [createTournament](#createtournament)
            * [Note:](#note-6)
   * [Main organization to be used:](#main-organization-to-be-used)
